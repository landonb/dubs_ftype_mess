...
"
" USYNC: meld ~/.vim/pack/landonb/start/dubs_ftype_mess/syntax/sh.vim ~/.local/share/vim/vim90/syntax/sh.vim &
" CXREF: meld sh-Version_203.vim sh-Version_203-lb.vim &
...
" - FIXME/2023-05-15: I did this for v189. Is it still necessary for v230?
"syn region  shSingleQuote	matchgroup=shQuote start=+'+ end=+'+		contains=@NoSpell	nextgroup=shSpecialStart,shSpecialSQ
"syn region  shDoubleQuote	matchgroup=shQuote start=+\%(\%(\\\\\)*\\\)\@<!"+ skip=+\\.+ end=+"+			contains=@shDblQuoteList,shStringSpecial,@NoSpell	nextgroup=shSpecialStart
