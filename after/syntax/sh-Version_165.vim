" [lb] downloaded 2016-10-26 from http://www.drchip.org/astronaut/vim/syntax/
"
" 2016-10-26: Well, this is the newest sh.vim (14.04's is version 131),
" but it highlights in red [like an error!] all $(...) command substitions,
" which is super annoying. And I don't really see any Bash syntax issues
" with the old file. So going to keep using the old file.
"
" 2016-10-26/ARGH: [lb] seeing system syntax file being loaded after our after/ file!
...
" 2016-10-26: [lb] disabling heredoc syntaxxing
if 0
...
" 2016-10-25: [lb] seeing everything after the <<< comment-colored [pink], e.g.,
